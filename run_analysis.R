# THis is the script for Coursera Getting and Cleaning Data project.

# The purpose of this project is to demonstrate your ability to collect, work 
# with, and clean a data set. The goal is to prepare tidy data that can be used 
# for later analysis. 

# Loading required packages. I had to find and install plyr first. 
library(plyr)
library(dplyr)

# READING AND EXPLORING FILES
# you can download and unzip the data from the provided URL on the coursera page
# or the readme file. Make sure that all the necessary files are in the same 
# working directory.

# FEATURES
features<- read.table("features.txt") # used for both X_train & X_test data
